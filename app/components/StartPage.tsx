...
// import { ProjectRequestP1 } from "./ProjectRequest";
...
import ImageComparisonSlider from './CompareList';
import IntroSection from './IntroSection';

export function StartPage({ toggleAnimation }: { toggleAnimation: () => void }) {
      ...
      <header id="header">
        ...
        <div className={styles['headline']}>
          ...
          <div className={styles['headlineTitle']}>
            {/* <h3 className="text-xl sm:text-2xl md:text-3xl xl:text-4xl font-semibold text-[#320435] pb-2">Für Coaches, Trainer und Therapeuten</h3> */}
            <h1>Digitale Lösungen, die Dein Business auf das nächste Level&nbsp;bringen:</h1>
            <TextAnimation strings={["Webdesign-& Entwicklung", "Automatisierung von Prozessen", "Termin-& Buchungssysteme", "Online-Marketing", "Suchmaschinenoptimierung", "Wartung & Updates"]} />

            <ul className="text-xl md:text-2xl font-normal text-[#320435]">
              <li><FontAwesomeIcon className='pr-2 text-green-500' icon={faCheck} />Online sichtbar werden und Zielgruppe&nbsp;erreichen</li>
              <li><FontAwesomeIcon className='pr-2 text-green-500' icon={faCheck} />Automatisiert und planbar Kunden&nbsp;gewinnen</li>
              <li><FontAwesomeIcon className='pr-2 text-green-500' icon={faCheck} />Zeit und Kosten sparen durch automatisierte&nbsp;Prozesse</li>
            </ul>

          </div>

          <button onClick={toggleAnimation} className={`${styles["cta"]} !mx-auto`}>
